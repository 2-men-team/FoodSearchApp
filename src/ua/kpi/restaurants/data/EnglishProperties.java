...
/**
 * Implements data-set-dependent operations for English data set.
...
public final class EnglishProperties implements LanguageProperties {
  ...
  /**
   * Provides access to word constraint specified for English data set.
  ...
  /**
   * Provides access to data constraint specified for English data set.
   * @return constraint {@link Predicate}
   */
  @Override
  ...
  /**
   * Provides access to stemming algorithm for English language.
